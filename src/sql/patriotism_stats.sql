...
select d.id, d.name, count(d_i.interpellation_id) as interpellations_count from deputy_interpellation as d_i
...
select id, name, count(*) as interpellations_count from (
    select d.id, d.name, i_s.interpellation_id
...
select a.id, a.name, p.interpellations_count as patriotic_interpellations, a.interpellations_count as all_interpellations,
